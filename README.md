...
An Engineer Cafe workshop starts from May 17th 2026.

## 特徴 (Features)

- MCU: Seeed Studio XIAO ESP32C3 (https://wiki.seeedstudio.com/ja/XIAO_ESP32C3_Getting_Started/)
- Display: 0.96" OLED 128 x 64 pix SSD1306
- Light: 3 NeoPixels
- Sound: Passive Buzzer
- Control: 4 momentary switches
...
本ソフトウェアのソースコードは **[GNU General Public License v3.0 (GPL-3.0)](https://www.gnu.org/licenses/gpl-3.0.html)** に基づき公開されています。
- 改変・再配布が可能です。
...
1. **名称の保持義務**: ソースコード内の著作権表示（Copyright (c) 2026 Thomas Leftwite/Wajiro Information Systems）は、改変の有無に関わらず削除しないでください。
2. **改変版の名称制限**: 本ソフトウェアを改変して公開・配布する場合、その製作物のタイトルやブランド名として "**Wajiro Information Systems**" を使用することはできません。
3. **公式性の否定**: 作者の書面による明示的な許可なく、本ソフトウェアの派生物を「Wajiro Information Systems 公式」として紹介・販売することを禁止します。

  ---

**Trademark Notice (English):**

The name "**Wajiro Information Systems**" and associated logos are trademarks of the author.
1. You must preserve the original copyright notice in the source code.
2. If you distribute a modified version of this software, you may not use the original trademark ("Wajiro Information Systems") as the name of your product or brand.
3. You may not claim any official affiliation with Wajiro Information Systems without prior written consent.

## 作者 (Author)

Thomas Leftwite (Wajiro Information Systems)
- Instagram: https://www.instagram.com/wajiro_information_systems/
